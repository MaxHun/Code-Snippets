...
def f(y, t, k): 
    ...
    return (
            ...
            (                         -(4.0*k[0]                         )*y[0])/(1-t),
            # S1D0T0Q0
            (4.0*k[0]*y[0]              -(3.0*k[0]+3.0*k[1]                  )*y[1])/(1-t),
            # S2D0T0Q0
            (3.0*k[0]*y[1]              -(2.0*k[0]+4.0*k[1]                  )*y[2])/(1-t),
            # S0D1T0Q0
            (3.0*k[1]*y[1]              -(2.0*k[0]         +2.0*k[2]         )*y[3])/(1-t),
            # S3D0T0Q0
            (2.0*k[0]*y[2]              -(1.0*k[0]+3.0*k[1]                  )*y[4])/(1-t),
            # S1D1T0Q0
            (4.0*k[1]*y[2]+2.0*k[0]*y[3]  -(1.0*k[0]+1.0*k[1]+1.0*k[2]           )*y[5])/(1-t),
            # S0D0T1Q0
            (2.0*k[2]*y[3]              -(1.0*k[0]+                 +1.0*k[3])*y[6])/(1-t),
            # S4D0T0Q0
            (1.0*k[0]*y[4]	                  			      )/(1-t),
            # S2D1T0Q0
            (1.0*k[0]*y[5]+3.0*k[1]*y[4]					    )/(1-t),
            # S0D2T0Q0
            (1.0*k[1]*y[5]							    )/(1-t),
            # S1D0T1Q0
            (1.0*k[0]*y[6]+1.0*k[2]*y[5]					    )/(1-t),
            # S0D0T0Q4
            (1.0*k[3]*y[6]							    )/(1-t) )
