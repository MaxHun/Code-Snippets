...
initialguess = [kS, kD, kT, kQ, SB1, SB2]
...
def f(y, t, k): 
    ...
    return (
            # S0D0T0Q0
            (                         -(4.0*k[0]                         )*y[0])/((t**k[4])*((1-t)**k[5])),
            # S1D0T0Q0
            (4.0*k[0]*y[0]              -(3.0*k[0]+3.0*k[1]                  )*y[1])/((t**k[4])*((1-t)**k[5])),
            # S2D0T0Q0
            (3.0*k[0]*y[1]              -(2.0*k[0]+4.0*k[1]                  )*y[2])/((t**k[4])*((1-t)**k[5])),
            # S0D1T0Q0
            (3.0*k[1]*y[1]              -(2.0*k[0]         +2.0*k[2]         )*y[3])/((t**k[4])*((1-t)**k[5])),
            # S3D0T0Q0
            (2.0*k[0]*y[2]              -(1.0*k[0]+3.0*k[1]                  )*y[4])/((t**k[4])*((1-t)**k[5])),
            # S1D1T0Q0
            (4.0*k[1]*y[2]+2.0*k[0]*y[3]  -(1.0*k[0]+1.0*k[1]+1.0*k[2]           )*y[5])/((t**k[4])*((1-t)**k[5])),
            # S0D0T1Q0
            (2.0*k[2]*y[3]              -(1.0*k[0]+                 +1.0*k[3])*y[6])/((t**k[4])*((1-t)**k[5])),
            # S4D0T0Q0
            (1.0*k[0]*y[4]	                  			      )/((t**k[4])*((1-t)**k[5])),
            # S2D1T0Q0
            (1.0*k[0]*y[5]+3.0*k[1]*y[4]					    )/((t**k[4])*((1-t)**k[5])),
            # S0D2T0Q0
            (1.0*k[1]*y[5]							    )/((t**k[4])*((1-t)**k[5])),
            # S1D0T1Q0
            (1.0*k[0]*y[6]+1.0*k[2]*y[5]					    )/((t**k[4])*((1-t)**k[5])),
            # S0D0T0Q4
            (1.0*k[3]*y[6]							    )/((t**k[4])*((1-t)**k[5])) )
...
pp.plot(x_data, y_data11, label='S0D0T0Q4', marker='x', linestyle='None', color = '#ff7f2f')
pp.plot(xeval,gls11(xeval), color='#ff7f2f')
